...
import { Camera, RefreshCw, Check, X, SwitchCamera, AlertCircle, Image as ImageIcon } from 'lucide-react';
          ...
          {capturedImage ? (
            <>
              ...
              <button
                ...
                className="flex-1 py-3 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-lg shadow-emerald-900/30 transition"
              >
                <Check className="w-4 h-4 text-white" />
                <span>تایید و ثبت عکس</span>
              </button>
            </>
          ) : (
            <>
